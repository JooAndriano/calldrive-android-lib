...
URL=https://calldrive.kaminsky.me/remote.php/webdav/library-integrationTests
USER=$1
PASS=$2
ID=$3
BRANCH=$4
...
curl -u $GIT_USERNAME:$GIT_TOKEN -X POST https://api.github.com/repos/calldrive/android-library/issues/$PR_ID/comments -d "{ \"body\" : \"$TYPE test failed: https://www.kaminsky.me/nc-dev/library-integrationTests/$REMOTE_FOLDER \" }"
exit 1
